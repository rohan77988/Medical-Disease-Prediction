...
model_path = "/Users/rohanchaudhari/Downloads/BtechProj copy/Checkpoints/MixedNet_checkpt(10).keras"

# Load the model
new_model = load_model(model_path)

BATCH_SIZE = 32
DATA_DIR = "/Users/rohanchaudhari/Downloads/BtechProj copy/skin-disease-datasaet"
...
def predict():
    ...
    if file:
        ...
        file.save(file_path)
        predictions = predict_image(new_model, file_path)
        return jsonify({'Predicted Disease': predictions})
